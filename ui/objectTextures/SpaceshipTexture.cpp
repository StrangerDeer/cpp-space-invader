...
void SpaceshipTexture::print(SDL_Renderer *renderer, Uint32 ticks) {
    ...
    SDL_QueryTexture(currentTexture, nullptr, nullptr, &spaceship->rect.w, &spaceship->rect.h);
    ...
    SDL_RenderCopyEx(renderer, currentTexture, &srcrect, &dstrect, 45, nullptr, SDL_FLIP_NONE);
}
